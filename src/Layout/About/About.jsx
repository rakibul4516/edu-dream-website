...
const About = () => {
    const trainers = DataFetch('/OurTrainers.json')
        ...
        <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
            <div className="container p-4 mx-auto sm:p-5">
                <div className="space-y-4 text-center">
                    ...
                    <p className="lg:w-8/12 w-11/12 mx-auto dark:text-gray-400 pb-5">Our team is a dynamic group of individuals who collaborate seamlessly to achieve our common goals. With diverse backgrounds and expertise, we bring a wealth of knowledge and creativity to every project we undertake. </p>
                </div>
                <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
...

                    {
                        trainers?.map(trainer => <>
                            <div className="">
                                <img alt="" className="object-cover h-72 mx-auto mb-4 bg-center rounded-sm dark:bg-gray-500 w-full" src={trainer.profile_image}/>
                                <div className="flex flex-col items-center text-center">
                                    <h4 className="text-xl font-semibold">{trainer.name}</h4>
                                    <p className="text-sm dark:text-gray-400">{trainer.profession}</p>
                                    <p className="text-sm dark:text-gray-400">{trainer.location}</p>
